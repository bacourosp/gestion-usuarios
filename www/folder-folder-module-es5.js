...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["folder-folder-module"], {
  ...
  function srcAppFolderFolderPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _api_storage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../api/storage.service */
    ...
    var _api_loading_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../api/loading.service */
    "./src/app/api/loading.service.ts");

    var FolderPage = /*#__PURE__*/function () {
      function FolderPage(menu, userService, alertController, loadingCtrl, router, storage, activatedRoute) {
      ...
      _createClass(FolderPage, [{
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    this.menu.enable(true); // this.folder = this.activatedRoute.snapshot.paramMap.get('id');

                    this.userService.validateLogin().subscribe(function (susses) {
                          ...
                          while (1) {
                            switch (_context.prev = _context.next) {
                              case 0:
                                ...
                                this.userService.getUser().subscribe(function (sussesGetUser) {
                                  console.log('sussesGetUser');
                                  console.log(sussesGetUser);
                                  _this2.users = sussesGetUser;
                                }, function (error) {
                                  console.log('error');
                                  console.log(error);
                                });
        ...
        value: function logout() {
          ...
          this.userService.logout().pipe().subscribe(function (susses) {
            _this3.storage.save(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].session, susses);
