...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-login-login-module"], {
  ...
  function srcAppAuthLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_api_user_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/api/user.service */
    "./src/app/api/user.service.ts");
    /* harmony import */


    var src_app_api_loading_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/api/loading.service */
    ...
    var src_app_api_storage_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/api/storage.service */
    "./src/app/api/storage.service.ts");

    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(storage, menu, userService, loadingCtrl, router) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return this.userService.login(form.form.value.email, form.form.value.password);
