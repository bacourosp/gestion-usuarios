...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  "./src/app/api/loading.service.ts":
  /*!****************************************!*\
    !*** ./src/app/api/loading.service.ts ***!
    \****************************************/
  ...
  /***/
  function srcAppApiLoadingServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/api/storage.service.ts":
  /*!****************************************!*\
    !*** ./src/app/api/storage.service.ts ***!
    \****************************************/
  ...
  /***/
  function srcAppApiStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var StorageService = /*#__PURE__*/function () {
      function StorageService(platform, storage) {
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    return _context6.abrupt("return", this.storage.get(key).then(function (data) {
                      return data;
                    }));
                  ...
                  case 4:
                    ...
                    return _context6.abrupt("return", JSON.parse(localStorage.getItem(key)));
            ...
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    return _context7.abrupt("return", this.storage.clear());
  ...
  function srcAppApiUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserService = /*#__PURE__*/function () {
      function UserService(storage, router, httpClient, alertController) {
      ...
      _createClass(UserService, [{
        ...
        value: function getUser() {
          ...
          return this.httpClient.get(this.urlServer + this.applicationID + this.apiKey + 'data/Users', {
            headers: headers
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])("Caught an error logout: ".concat(error));
          }));
        } // registro

      }, {
        key: "registry",
        value: function registry(name, email, pass) {
            ...
            return regeneratorRuntime.wrap(function _callee10$(_context10) {
              while (1) {
                switch (_context10.prev = _context10.next) {
                  case 0:
                    return _context10.abrupt("return", this.httpClient.post(this.urlServer + this.applicationID + this.apiKey + 'users/register', JSON.stringify(this.createJSONRegistry(name, email, pass))).subscribe(function (res) {
        ...
        key: "createJSONRegistry",
        value: function createJSONRegistry(nombre, correo, clave) {
          var jsonLogin = {
            email: correo,
            name: nombre,
            password: clave
            ...
            return regeneratorRuntime.wrap(function _callee12$(_context12) {
              while (1) {
                switch (_context12.prev = _context12.next) {
                  case 0:
                    return _context12.abrupt("return", this.httpClient.post(this.urlServer + this.applicationID + this.apiKey + 'users/login', JSON.stringify(this.createJSONLogin(email, pass))).subscribe(function (res) {
                      ...
                      if (res.status === 401) {
                        ...
                        _this3.token = res['user-token'];
                        console.log('token login');
                        console.log(_this3.token);

                        _this3.storage.save(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].session, res);

                        _this3.router.navigate(['/folder/Users']);
                      }
                    }, function (error) {
                      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this3, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
                        var _alert3;
        ...
        key: "getCodeHTTP",
        value: function getCodeHTTP(error) {}
      }, {
        key: "createJSONLogin",
        value: function createJSONLogin(email, pass) {
          var jsonLogin = {
            login: email,
            password: pass
          };
