...
/* harmony import */ var _storage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./storage.service */ "./src/app/api/storage.service.ts");
...
let UserService = class UserService {
    constructor(storage, router, httpClient, alertController) {
        this.storage = storage;
        this.router = router;
    ...
    getUser() {
        ...
        return this.httpClient.get(this.urlServer + this.applicationID + this.apiKey + 'data/Users', { headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(`Caught an error logout: ${error}`);
        }));
    }
    // registro
    registry(name, email, pass) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return this.httpClient.post(this.urlServer + this.applicationID + this.apiKey + 'users/register', JSON.stringify(this.createJSONRegistry(name, email, pass)))
    ...
    createJSONRegistry(nombre, correo, clave) {
        const jsonLogin = {
            email: correo,
            name: nombre,
            password: clave
    ...
    logout() {
        ...
        return this.httpClient.get(this.urlServer + this.applicationID + this.apiKey + 'users/logout', { headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.extractData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(`Caught an error logout: ${error}`);
        }));
    }
    login(email, pass) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return this.httpClient.post(this.urlServer + this.applicationID + this.apiKey + 'users/login', JSON.stringify(this.createJSONLogin(email, pass)))
                .subscribe((res) => {
                ...
                if (res.status === 401) {
                    ...
                    this.storage.save(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].session, res);
